...
impl DonneesImage {
    ...
    pub fn nouvelle(view_proj: Mat4, camera_monde: [f32; 3], lumieres: &[GpuLight]) -> Self {
...
mod tests {
    ...
    fn le_compte_de_lumieres_suit_ce_qui_est_donne() {
        ...
        let d = DonneesImage::nouvelle(Mat4::IDENTITY, [0.0, 0.0, 0.0], &[soleil, soleil, soleil]);
        ...
        let aucune = DonneesImage::nouvelle(Mat4::IDENTITY, [0.0, 0.0, 0.0], &[]);
    ...
    fn trop_de_lumieres_sont_bornees_et_le_compte_le_dit() {
        ...
        let d = DonneesImage::nouvelle(Mat4::IDENTITY, [1.0, 2.0, 3.0], &trop);
        assert_eq!(
            d.lumieres_actives(),
            MAX_LUMIERES,
