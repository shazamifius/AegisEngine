...
impl FlamethrowerObject {
    ...
    pub fn draw(&self, pose: &aegis_engine::render::instances::Pose, cube_mesh: &GpuMesh, vp: Mat4, pos: Vec2, dir: Direction, active: bool, time: f32) {
        self.draw_at_3d(pose, cube_mesh, vp, Vec3::new(pos.x, pos.y, 0.1), dir, 1.0, active, time);
    }
