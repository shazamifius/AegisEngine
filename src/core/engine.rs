...
impl GlassSceneRenderPass {
    pub fn new(
        ...
        let instances = vec![
            ...
            // 3. Dalle Capsule Premier Plan (VERRE CRISTALLIN CLAIR CYAN AU-DESSUS, Transmittance 98%)
            GlassSlabInstance {
                position: Vec3::new(-0.08, 0.28, 0.40),
                rotation_z: -36.0f32.to_radians(),
                rotation_x: -2.0f32.to_radians(),
                scale: Vec3::new(0.68, 0.68, 0.16),
                tint: Vec4::new(0.92, 0.98, 1.00, 0.05),
                rugosite: 0.10,
            },
        ];
